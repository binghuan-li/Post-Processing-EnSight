...
ensight.part.select_begin(wall_part_ID)
ensight.variables.evaluate("OSI = 0.5 * ( 1 - (rms_tempmean_wss/TAWSS))")
print('--> OSI calculation successful!')

# calculate ECAP
ensight.part.select_begin(wall_part_ID)
ensight.variables.evaluate("ECAP = OSI/TAWSS")
...
ensight.variables.evaluate("TI = SQRT((2/3) * Turbulence_Kinetic_Energy)/Velocity")
